...
## Output
<img width="816" height="371" alt="image" src="https://github.com/user-attachments/assets/f050b263-9afe-48d0-9846-937470c00892" />

## Result
 a **DataFrame** using the **Pandas** library in Python from a given dictionary, and apply specific index labels to the rows is written successfully
